              ...
              <div className="overflow-x-auto overflow-y-hidden snap-x snap-mandatory scroll-smooth">
                <div className="flex gap-4 pb-4 py-10 min-w-min">
                  {dummy.map((item, index) => (
                    <div
                      key={index}
                      className="flex-shrink-0 w-[240px] lg:w-[270px] snap-start bg-white shadow-lg rounded-lg max-h-[675px]"
                      data-aos="fade-up"
                        ...
                        <div className="group bg-white shadow-xl rounded-lg max-h-[675px] h-full block hover:scale-105 transition-transform ease-in-out duration-500">
                          <div className="relative overflow-hidden  h-[150px] lg:h-[250px] w-full">
                            <img
                              src={item.img}
                              alt=""
                              className="w-full h-full rounded-t-2xl object-cover transition-transform duration-500 ease-in-out group-hover:scale-105"
                            />
                    ...
                    <div className="group bg-white shadow-xl rounded-lg max-h-[675px] h-full block hover:scale-105 transition-transform ease-in-out duration-500">
                      <div className="relative overflow-hidden  h-[150px] lg:h-[250px] w-full">
                        <img
                          src={item.img}
                          alt=""
                          className="w-full h-full rounded-t-2xl object-cover bg-center bg-contain transition-transform duration-500 ease-in-out group-hover:scale-105"
                        />
                        <div className="bg-white py-1 px-3 rounded-full flex items-center absolute top-4 left-4 gap-2 z-10">
                          <button
                            className="border-2 rounded-full px-2 border-[#F17228] text-[#F17228] font-bold hover:bg-[#F17228] hover:text-white transition-colors duration-300"
